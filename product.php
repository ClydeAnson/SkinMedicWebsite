...
<head>
    ...
    <style>
        ...
        .buy-btn:hover { background-color: #829b53; }
        @keyframes fadeIn {
...
<body>
    <div class="main">
        ...
        <div class="welcome-section">
            ...
            <img src="skintransparent.png" width="150" alt="Store">
        </div>
        ...
        <div class="store-section">
            ...
            <div class="store-container">
                <?php
                $query = "SELECT * FROM products WHERE status='available' AND quantity > 0";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "
                        <div class='product-card' onclick=\"openModal('$name','$description','$price','uploads/$image',$product_id)\">
                            <img src='uploads/$image' alt='$name' onerror=\"this.src='https://i.ibb.co/2s7sG4v/placeholder.png'\">
                            <div class='details'>
                                <h4>$name</h4>
                                <p>₱$price</p>
                            </div>
    ...
    <div id="productModal" class="modal">
        <div class="modal-content">
            ...
            <a id="buyButton" class="buy-btn">Buy Now</a>
        </div>
    </div>
    ...
    <script>
        ...
        function openModal(name, desc, price, image, product_id) {
            modal.style.display = 'flex';
            modalName.textContent = name;
            modalDesc.textContent = desc;
            modalPrice.textContent = "₱" + price;
            modalImage.src = image;
            buyButton.href = 'purchase.php?product_id=' + product_id;
        }
